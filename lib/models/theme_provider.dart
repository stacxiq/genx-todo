...
class ThemeProvider with ChangeNotifier {
  bool isLightTheme;
  String prefrencesColor;
  String languageCode;

  ThemeProvider({
    this.isLightTheme,
    this.prefrencesColor,
    this.languageCode,
  });
  ...
  getCurrentStatusNavigationBarColor() {
    if (isLightTheme) {
      ...
      SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
        ...
        systemNavigationBarColor: Color(0xFF424360),
  ...
  changePrefrencesColor(String color) async {
    final settings = await Hive.openBox('settings');
    settings.put('prefrencesColor', color);
    prefrencesColor = color;
    notifyListeners();
  }
